	...
	<div class="hero">
		<div class="form-box">
			...
			<form  id="register" class="input-group" method="post">
				...
				<input type="text" name="password" id="v1" class="input-field" placeholder="Enter Password" required>
				<input type="text" name="cpassword" id="v2" class="input-field" placeholder="Confirm Password" required>
